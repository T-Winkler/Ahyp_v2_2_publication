#!/bin/bash -l
#SBATCH -D /projects/ag-stetter/markus/bsa_sterility_color
#SBATCH -o /projects/ag-stetter/markus/bsa_sterility_color/logs/mappingLog-%j.txt
...
REFERENCE=/projects/mstette2/reference_genomes/Ahypochondriacus/V2_1/Ahypochondriacus_459_v2.0.fa
...
INPUTPATH=raw_data/ # 
OUTPUTPATH=data/bam_files # Change this for different generations
